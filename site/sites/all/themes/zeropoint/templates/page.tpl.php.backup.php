...
---------------------------
	...
	<div class="container content">
		<div class="col-md-12 box espacio-opcional">
			espacio para lo que sea
		</div>
		<div class="fivecolumns">
			<div class="col-sm-2 box contactos-paises">
				contacto panama
			</div>
			<div class="col-sm-2 box contactos-paises">
				contacto venezuela
...
<div class="container-fluid footer">
	<div class="container content">
		...
		<div class="fivecolumns">
			...
			<div class="col-sm-5 box contactos-paises">
				datos de copyright, contacto y eso.
			</div>
			<div class="col-sm-2 box contactos-paises">
				nota legal
			</div>
